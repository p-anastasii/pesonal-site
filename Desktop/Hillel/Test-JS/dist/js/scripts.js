...
Student.prototype.present = function () {
  var index = this.attendance.indexOf(null);
  if (index !== -1) {
...
Student.prototype.summary = function () {
  var averageMark = this.getAverageMark();
...
var studentAnna = new Student('Anna', 'Roy', 2002, [75, 82, 90, 85]);
var studentBob = new Student('Bob', 'Smith', 2000, [96, 85, 100, 95]);
var studentAlex = new Student('Alex', 'Alexandrov', 2004, [99, 95, 92, 89]);
console.log("\u0406\u043C'\u044F: ".concat(studentAnna.name, " ").concat(studentAnna.lastName));
console.log("\u0412\u0456\u043A: ".concat(studentAnna.getAge()));
console.log("\u0421\u0435\u0440\u0435\u0434\u043D\u0456\u0439 \u0431\u0430\u043B: ".concat(studentAnna.getAverageMark()));
studentAnna.present();
studentAnna.present();
studentAnna.absent();
studentAnna.present();
console.log("\u0421\u0435\u0440\u0435\u0434\u043D\u0454 \u0432\u0456\u0434\u0432\u0456\u0434\u0443\u0432\u0430\u043D\u043D\u044F: ".concat(studentAnna.getAverageAttendance()));
console.log("\u041F\u0456\u0434\u0441\u0443\u043C\u043E\u043A: ".concat(studentAnna.summary()));
console.log("\u0406\u043C'\u044F: ".concat(studentBob.name, " ").concat(studentBob.lastName));
console.log("\u0412\u0456\u043A: ".concat(studentBob.getAge()));
console.log("\u0421\u0435\u0440\u0435\u0434\u043D\u0456\u0439 \u0431\u0430\u043B: ".concat(studentBob.getAverageMark()));
studentBob.present();
studentBob.present();
studentBob.present();
studentBob.present();
console.log("\u0421\u0435\u0440\u0435\u0434\u043D\u0454 \u0432\u0456\u0434\u0432\u0456\u0434\u0443\u0432\u0430\u043D\u043D\u044F: ".concat(studentBob.getAverageAttendance()));
console.log("\u041F\u0456\u0434\u0441\u0443\u043C\u043E\u043A: ".concat(studentBob.summary()));
console.log("\u0406\u043C'\u044F: ".concat(studentAlex.name, " ").concat(studentAlex.lastName));
console.log("\u0412\u0456\u043A: ".concat(studentAlex.getAge()));
console.log("\u0421\u0435\u0440\u0435\u0434\u043D\u0456\u0439 \u0431\u0430\u043B: ".concat(studentAlex.getAverageMark()));
studentAlex.present();
studentAlex.absent();
studentAlex.absent();
studentAlex.present();
console.log("\u0421\u0435\u0440\u0435\u0434\u043D\u0454 \u0432\u0456\u0434\u0432\u0456\u0434\u0443\u0432\u0430\u043D\u043D\u044F: ".concat(studentAlex.getAverageAttendance()));
console.log("\u041F\u0456\u0434\u0441\u0443\u043C\u043E\u043A: ".concat(studentAlex.summary()));